...
export const copy = {
  en: {
    ...
    leaderboardTitle: 'Top Arcade Participants',
    leaderboardEmpty: 'No participants on the leaderboard yet. Check a profile to get started!',
  ...
  id: {
    ...
    leaderboardKicker: 'Leaderboard',
    leaderboardTitle: 'Peserta Arcade Teratas',
    leaderboardEmpty: 'Belum ada peserta di leaderboard. Check profile untuk memulai!',
